...
; output file
!ifndef OutFile
    !define OutFile "vadar-agent-${VERSION}.exe"
!endif

Var is_upgrade

Name "${NAME} Windows Agent v${VERSION}"
BrandingText "Copyright (C) 2015-2019, VSEC Inc."
OutFile "${OutFile}"

VIProductVersion "3.10.0.0"
VIAddVersionKey ProductName "${NAME}"
VIAddVersionKey CompanyName "Vadar Inc."
VIAddVersionKey LegalCopyright "2019 - VSEC Inc."
VIAddVersionKey FileDescription "Vadar Agent installer"
VIAddVersionKey FileVersion "${VERSION}"
VIAddVersionKey ProductVersion "${VERSION}"
VIAddVersionKey InternalName "Vadar Agent"
